<!DOCTYPE html>
<!--index.html
For the Windows 10 App project
...
<meta charset="UTF-8">
<title>Windows 10 App</title>
<meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1.0">
<meta name="application-name" content="Windows 10 App">
...
<link rel="apple-touch-icon" href="small.jpg">
...
<div class="titleFrame" >
<div class="titleContent">
<div class="iconContainer"><img class="icon" src="data:image/png;base64," alt=" "></div><div class="titleText">Untitled - Notepad</div>
</div>
<div class="closeBtn" id="npClose">&times;</div>
</div>
<div class="winbody" id="notepadBody">
<div class="menubar"><button class="menubarItem" onclick="javascript:menuItem();">File</button><button class="menubarItem">Edit</button><button class="menubarItem">Format</button><button class="menubarItem">View</button><button class="menubarItem">Help</button></div>
<div id="dropdown" class="dropdown">
    <a id="npNew">New</a>
    <a id="npOpen"><span>Open...</span><input type="file" id="npFileSel" class="npFileSel" onchange="onFileSelected(event)" accept="text/*"></a>
    <a id="npSave">Save</a>
    <a id="npSaveAs">Save As...</a>
    <hr class="dropdown-separator">
    <a id="npPageSetup">Page Setup</a>
    <a id="npPrint">Print...</a>
    <hr class="dropdown-separator">
    <a id="npExit">Exit</a>
  </div>
<textarea class="textBox" id="npTextarea"></textarea>
</div>
</div>
...
<div class="window" id="msofw">
<div class="titleFrame" >
<div class="titleContent">
<div class="iconContainer"><img class="icon" src="img/w.png" alt=" "></div><div class="titleText">Document - Word</div>
</div>
<div class="closeBtn" id="msofwClose">&times;</div>
</div>
<div class="msofwbody" id="msofwBody">
<div class="msofwmenubar">
 <button class="msofwmenubarItem"  onclick="location.href='1.html'">File</button>
 <button class="msofwmenubarItem">Edit</button>
 <button class="msofwmenubarItem">Format</button>
 <button class="msofwmenubarItem">View</button>
 <button class="msofwmenubarItem">Help</button>
</div>
<div id="dropdown" class="dropdown">
    <a id="msofwNew">New</a>
    <a id="npOpen"><span>Open...</span><input type="file" id="npFileSel" class="npFileSel" onchange="onFileSelected(event)" accept="text/*"></a>
    <a id="msofwSave">Save</a>
    <a id="msofwTextarea">Save As...</a>
    <hr class="dropdown-separator">
    <a id="msofwPageSetup">Page Setup</a>
    <a id="msofwPrint">Print...</a>
    <hr class="dropdown-separator">
    <a id="msofwExit">Exit</a>
  </div>
...
<!--
<textarea class="textBox" id="msofwTextarea"></textarea>
-->
...
<div class="startMenu" id="startMenu" style="display: none;">
					<div class="startApps" id="startApps">
						<ul>
							<li><a title="Notepad"><i class="icono fa fa-pencil-square-o"></i>Notepadddd<i class="icono2 fa fa-caret-right"></i></a></li>
							<li><a title="Microsoft Edge"><i class="icono fa fa-edge"></i>Microsoft Edge<i class="icono2 fa fa-caret-right"></i></a></li>
						</ul>
					</div>
					<div class="btnPower" id="power" title="Power">
						<i class="fa fa-power-off"></i>
					</div>
					<div class="btnSettings" id="settings" title="Settings">
						<i class="fa fa-cog"></i>
					</div>
					<div class="btnUser" id="userMenu" title="User">
						<i class="fa fa-user"></i>
					</div>
					<div class="btnExpandMenu" id="expandMenu" title="Expand">
...
<img class="SearchResults" id="SearchResults" src="img/SearchResults.png" alt=" ">
<div class="taskbar">
<div class="startIconFrame" id="startIconFrame" title="Start">
<i class="fa fa-windows"></i>
</div>
<form method="get" action="https://www.bing.com/search">
<input type="text" name="q" value="" class="taskSearch" id="taskSearch" placeholder="Search the web and Windows">
</form>
<div class="otherIconFrame" id="taskviewIconFrame" title="Task View">
<i class="fa fa-tasks"></i>
</div>
<div class="edgeIconFrame" id="edgeIconFrame" title="Microsoft Edge">
<i class="fa fa-edge"></i>
</div>
<div class="otherIconFrame" id="notepadIconFrame" title="Notepad">
<i class="fa fa-pencil-square-o"></i>
</div>

<div class="otherIconFrame" id="msofwIconFrame" title="Notepad">
<i class="fa fa-pencil-square-o"></i>
</div>
<div class="otherIconFrame" id="winverIconFrame" title="About Windows">
  <i class="fa fa-question-circle-o"></i>
  </div>
<div class="taskClock" id="taskClockContainer">
  <div class="taskClockContent" id="taskClock">
  </div>
</div>
<div class="showDesktop" id="showDesktop" title="Show Desktop"></div>
</div>
</div>
